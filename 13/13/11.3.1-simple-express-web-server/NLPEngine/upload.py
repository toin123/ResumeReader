...
# In[5]:
mypath = "C:/Users/jakuz/Documents/13/13/11.3.1-simple-express-web-server/Grab"
...
glove_file = "C:/Users/jakuz/Documents/13/13/11.3.1-simple-express-web-server/NLPEngine/glove_words.txt"
...
for resume in single_embeddings:
    ...
    for activity in single_embeddings[resume][1]:
        ...
        for word_embedding in single_embeddings[resume][1][activity][1]:
            ...
            single_embeddings[resume][1][activity][1][word_embedding] = \
            single_embeddings[resume][1][activity][1][word_embedding][0] * \
            single_embeddings[resume][1][activity][1][word_embedding][1]
...
yx_label = {}
with open("C:/Users/jakuz/Documents/13/13/11.3.1-simple-express-web-server/NLPEngine/rf_model.sav", 'rb') as g:
    loaded_model = pickle.load(g)
prediction = loaded_model.predict_proba([resume_embeddings[0][1]])
pred = prediction[0].tolist().index(max(prediction[0]))
if pred == 0:
    pred = "AI"
elif pred == 1:
    pred = "Full_Stack"
...
print(yx_label)
uploadDoc = yx_label[resume_embeddings[0][0]]

# Firebase upload
cred = credentials.Certificate("C:/Users/jakuz/Documents/13/13/11.3.1-simple-express-web-server/NLPEngine/resumereader-6bf10-firebase-adminsdk-4gbrl-44186fed54.json")
firebase_admin.initialize_app(cred)
db = firestore.client()
doc_ref = db.collection(u'users').document(resume_embeddings[0][0])
doc_ref.set(uploadDoc)
